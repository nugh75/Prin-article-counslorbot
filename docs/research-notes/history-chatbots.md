...
> Solo riferimenti con full text verificabile (PDF in `bibliography/pdf/`).
...
- **PDF**: `bibliography/pdf/1966_weizenbaum_eliza-a-computer-program.pdf`
...
- **PDF**: `bibliography/pdf/2014_amershi-et-al_power-to-the-people-the-role-of-humans-in-interactive-machine-learning.pdf` (Bronze OA — recuperato da Wayback Machine)
...
- **PDF**: `bibliography/pdf/2017_vaswani-et-al_attention-is-all-you-need.pdf` (arXiv)
- Vaswani, A., et al. (2017). Attention Is All You Need. *NeurIPS*, 30.

### 2018 — BERT (Devlin et al.)
- **PDF**: `bibliography/pdf/2019_devlin-et-al_bert-pre-training-of-deep-bidirectional-transformers.pdf` (arXiv)
- Devlin, J., et al. (2019). BERT. *NAACL-HLT*.

### 2019 — GPT-2 (Radford et al.)
- **PDF**: `bibliography/pdf/2019_radford-et-al_language-models-are-unsupervised-multitask-learners.pdf` (OpenAI)
- Radford, A., et al. (2019). Language Models are Unsupervised Multitask Learners.

### 2020 — GPT-3 (Brown et al.)
- **PDF**: `bibliography/pdf/2020_brown-et-al_language-models-are-few-shot-learners.pdf` (arXiv)
- Brown, T. B., et al. (2020). Language Models are Few-Shot Learners. *NeurIPS*, 33.

### 2020 — GPT-3: Nature, Scope, Limits (Floridi & Chiriatti)
- **PDF**: `bibliography/pdf/2020_floridi_chiriatti_gpt-3-its-nature-scope-limits-and-consequences.pdf` (Springer OA)
- Floridi, L., & Chiriatti, M. (2020). GPT-3: Its Nature, Scope, Limits, and Consequences. *Minds and Machines*, 30, 681–694.

### 2024 — Wang et al. — Survey LLM Agents
- **PDF**: `bibliography/pdf/2024_wang-et-al_a-survey-on-large-language-model-based-autonomous-agents.pdf`
